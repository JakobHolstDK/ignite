...
tests/files/test_json_vm_explode_type_match.expect
tests/files/unknown_method.xml
tests/fixtures/basic_connection.yaml
tests/fixtures/basic_connection_bad_password.yaml
tests/fixtures/basic_container_view.yaml
tests/fixtures/http_proxy.yaml
tests/fixtures/iso8601_set_datetime.yaml
tests/fixtures/pbm_check_compatibility.yaml
...
tests/fixtures/test_json_datacenter_explode.yaml
tests/fixtures/test_json_datastore_explode.yaml
tests/fixtures/test_json_host_explode.yaml
tests/fixtures/test_json_network_explode.yaml
tests/fixtures/test_json_vm_explode_default.yaml
tests/fixtures/test_json_vm_explode_objs.yaml
tests/fixtures/test_json_vm_explode_strip_dynamic.yaml
tests/fixtures/test_json_vm_explode_type.yaml
tests/fixtures/test_simple_request_serializer.yaml
